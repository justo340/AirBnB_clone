...
class TestCity(unittest.TestCase):
    ...
    def test_basic_attribute_set(self):
        ...
        """
        self.C.first_name = 'Justus'
        self.C.last_name = 'Njogu'
        self.assertEqual(self.C.first_name, 'Justus')
        self.assertEqual(self.C.last_name, 'Njogu')

    def test_string_return(self):
        """tests the str method
        """
        string = str(self.C)
        Cid = "[{}] ({})".format(self.C.__class__.__name__,self.C.id)
        test = Cid in string
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(my_dict['created_at'],self.C.created_at.isoformat())
        self.assertEqual(datetime, type(self.C.created_at))
        self.assertEqual(my_dict['__class__'],self.C.__class__.__name__)
    ...
    def test_from_dict_basic(self):
        ...
        self.assertEqual(C1.__class__.__name__, self.C.__class__.__name__)
    ...
    def test_from_dict_hard(self):
        ...
        self.C.last_name = 'Njogu'
        my_dict = self.C.to_dict()
        self.assertEqual(my_dict['first_name'], 'Justus')
        C1 = self.C.__class__(**my_dict)
        self.assertEqual(C1.created_at, self.C.created_at)
