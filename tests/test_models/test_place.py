...
class TestPlace(unittest.TestCase):
    ...
    def test_pep8_conformance_Place(self):
        """
        Test that place.py file conform to PEP  """
    ...
    def test_basic_attribute_set(self):
        ...
        """
        self.P.first_name = 'Justus'
        self.P.last_name = 'Njogu'
        self.assertEqual(self.P.first_name, 'Justus')
        self.assertEqual(self.P.last_name,'Njogu')

    def test_string_return(self):
        """tests the string method
        """
        string = str(self.P)
        Pid = "[{}] ({})".format(self.P.__class__.__name__, self.P.id)
        test = Pid in string
