...
class TestUser(unittest.TestCase):
    ...
    def test_type(self):
        ...
        self.assertEqual(isinstance(self.Us, User), True)
        self.assertEqual(type(self.Us), User), User)
    
    def test_basic_attribute_set(self):
        """Basic attribute tests for user model
        """
        self.Us.first_name = 'Justus'
        self.Us.last_name = 'Njogu'
        self.assertEqual(self.Us.first_name, 'Justus')
        self.assertEqual(self.Us.last_name, 'Njogu')
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(my_dict['created_at'], self.Us.created_at.isoformat())
        self.assertEqual(datetime, type(self.Us.created_at))
        self.assertEqual(my_dict['__class__'], self.Us.__class__.__name__)
    ...
    def test_from_dict_basic(self):
        ...
        self.assertEqual(Us1.__class__.__name__, self.Us.__class__.__name__)
