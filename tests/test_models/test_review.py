...
class TestReview(unittest.TestCase):
    ...
    def test_string_return(self):
        ...
        """
        string = str(self.R)
        Rid = "[{}] ({})".format(self.R.__class__.__name__, self.R.id)
        test = Rid in string
        self.assertEqual(True, test)
        test = "update_at" in string
        self.assertEqual(True, test)
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(my_dict['created_at'], self.R.created_at.isoformat())
        self.assertEqual(datetime, type(self.R.created_at))
        self.assertEqual(my_dict['__class__'], self.R.__class__.__name__)
    ...
    def test_from_dict_basic(self):
        ...
        self.assertEqual(R1.__class__.__name__, self.R.__class__.__name__)
    ...
    def test_from_dict_hard(self):
        ...
        self.R.name = 'Justus'
        my_dict = self.R.to_dict()
        self.assertEqual(my_dict['name'], 'Justus')
        R1 = self.R.__class__(**my_dict)
        self.assertEqual(R1.created_at, self.R.created_at)
